...
class LeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #conv 1 & 2 ReLU, max, and adding it to dict
        ...
        # flatten and add to dict
        x = x.view(-1, 16*5*5);
        shape_dict[3] = list(x.shape);

        # connect with ReLU and adding fc 1, 2, and 3 to dict
